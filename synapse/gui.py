...
<style>
:root{--bg:#0d1117;--fg:#c9d1d9;--acc:#58a6ff;--bdr:#30363d}
*{margin:0;padding:0;box-sizing:border-box}
body{background:var(--bg);color:var(--fg);font-family:system-ui;height:100vh;display:flex;flex-direction:column}
header{padding:12px 16px;border-bottom:1px solid var(--bdr);background:#010409;display:flex;justify-content:space-between;align-items:center}
...
#inp{flex:1;background:#161b22;border:1px solid var(--bdr);color:var(--fg);padding:10px;border-radius:8px;outline:none;font-size:14px}
